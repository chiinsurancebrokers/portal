    ...
    if brevo_user and brevo_pass:
        try:
            ...
            with smtplib.SMTP("smtp-relay.brevo.com", 587, timeout=20) as srv:
                ...
                srv.sendmail("xiatropoulos@gmail.com", [to_email, "xiatropoulos@gmail.com"], msg.as_string())
            return True, ""
        except Exception as e:
    ...
    if gmail_user and gmail_pass:
        try:
            ...
            with smtplib.SMTP("smtp.gmail.com", 587, timeout=20) as srv:
                ...
                srv.sendmail(gmail_user, [to_email, "xiatropoulos@gmail.com"], msg.as_string())
            return True, ""
        except Exception as e:
